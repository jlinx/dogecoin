...
----------------------
    ...
    brew install jlinx/formulas/berkeley-db@5 # You need to make sure you install a version >= 5.1.29, but as close to 5.1.29 as possible. Check the homebrew docs to find out how to install older versions.
